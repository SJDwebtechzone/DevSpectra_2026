...
export declare class ProjectsController {
    ...
    update(id: string, updateProjectDto: Partial<CreateProjectDto>): Promise<import("./entities/project.entity").Project>;
    remove(id: string): Promise<import("./entities/project.entity").Project>;
}
