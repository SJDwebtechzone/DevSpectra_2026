...
let DashboardService = class DashboardService {
    projectsRepository;
    contactsRepository;
    constructor(projectsRepository, contactsRepository) {
        this.projectsRepository = projectsRepository;
        this.contactsRepository = contactsRepository;
    }
    async getDashboardStats() {
        const [totalProjects, totalContacts, unreadContacts, featuredProjects, latestProjects, latestContacts,] = await Promise.all([
