        ...
        <div className="flex flex-col justify-center items-center gap-6 mb-8 w-full">
          ...
          <div className="flex items-center gap-6 text-gray-400">
            ...
            <a
              ...
              aria-label="LinkedIn"
              className="hover:text-[#0077B5] hover:-translate-y-1 transition-all duration-300"
            >
            ...
            <a
              ...
              rel="noopener noreferrer"
              aria-label="Facebook"
              className="hover:text-[#1877F2] hover:-translate-y-1 transition-all duration-300"
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a
              ...
              className="hover:text-[#E4405F] hover:-translate-y-1 transition-all duration-300"
            >
            ...
            <a
              ...
              rel="noopener noreferrer"
              aria-label="YouTube"
              className="hover:text-[#FF0000] hover:-translate-y-1 transition-all duration-300"
            >
            ...
            >
              <JustdialIcon className="w-6 h-6 rounded-md shadow-sm" />
            </a>
          </div>
