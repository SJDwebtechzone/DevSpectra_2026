        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-[73%] sm:top-[75%] lg:top-[76%] left-[22%] flex flex-col items-start w-[75%] md:w-[65%] lg:w-[60%]">
            <div className="origin-top-left scale-[0.4] min-[400px]:scale-[0.5] sm:scale-[0.7] md:scale-[0.85] lg:scale-100 flex flex-row items-center gap-4 lg:gap-6 mt-0.5 sm:mt-1 lg:mt-3">
              <a href="/contact" className="pointer-events-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-[#0f172a] hover:bg-[#1e293b] text-white rounded-full font-medium text-base transition-colors shadow-md group whitespace-nowrap">
              ...
              <a href="/portfolio" className="pointer-events-auto inline-flex items-center justify-center gap-2 px-5 py-3.5 bg-white hover:bg-gray-50 border border-gray-200 text-gray-700 rounded-full font-medium text-base transition-colors shadow-sm group whitespace-nowrap">
