export default function FeatureSection() {
  return (
    <section className="relative flex min-h-[52vh] w-full items-end justify-center overflow-hidden border-b border-black/10 bg-[#b8f000] px-5 pb-0 sm:min-h-[60vh] sm:px-8 lg:min-h-[68vh]">
      ...
      <h1 className="absolute bottom-0 left-0 z-10 w-full px-1 text-center whitespace-nowrap text-[clamp(1rem,8vw,9.5rem)] font-black uppercase leading-[0.9] tracking-[-0.07em] text-black">
        Let&apos;s Work Together
      </h1>
    </section>
  );
