    ...
    <div className="w-full bg-white">
      <div className="relative mx-auto w-full max-w-[1500px]" style={{ aspectRatio: `${CANVAS_W} / ${CANVAS_H}` }}>
        ...
        <h1 aria-label="Bring a team together" className="absolute inset-0">
          <span className="absolute font-black leading-[0.9] tracking-tight text-neutral-900" style={{ ...pos(60, 40), fontSize: "clamp(28px, 7.2vw, 70px)" }}>bring</span>
          <span className="absolute font-black leading-[0.9] tracking-tight text-neutral-900" style={{ ...pos(180, 112), fontSize: "clamp(28px, 7.2vw, 70px)" }}>a team</span>
          <span className="absolute font-black leading-[0.9] tracking-tight text-neutral-900" style={{ ...pos(286, 177), fontSize: "clamp(28px, 7.2vw, 70px)" }}>together</span>
        </h1>
        ...
        <div className="absolute hidden items-center justify-center rounded-full bg-white shadow-lg md:flex" style={{ ...pos(466, 40, 68, 68), fontSize: "clamp(20px,3.6vw,34px)" }}>🥳</div>
