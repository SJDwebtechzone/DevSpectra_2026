  ...
  return (
    <section className="w-full bg-white">
      <div className="relative mx-auto w-full max-w-[1400px] overflow-hidden [container-type:inline-size]" style={{ aspectRatio: `${CANVAS_W} / ${CANVAS_H}` }}>
        <div className="absolute font-display font-black leading-[0.9] tracking-[-0.04em] text-neutral-950" style={{ ...pos(50, 15), fontSize: "clamp(24px, 6.6cqw, 62px)" }}>
          bring
        </div>
        <div className="absolute font-display font-black leading-[0.9] tracking-[-0.04em] text-neutral-950" style={{ ...pos(150, 95), fontSize: "clamp(24px, 6.6cqw, 62px)" }}>
          a team
        </div>
        <div className="absolute font-display font-black leading-[0.9] tracking-[-0.04em] text-neutral-950" style={{ ...pos(300, 175), fontSize: "clamp(24px, 6.6cqw, 62px)" }}>
          together
        </div>
        ...
        <div className="absolute hidden items-center justify-center sm:flex" style={{ ...pos(450, 15, 70, 70), fontSize: "clamp(22px,3.8cqw,36px)" }}>🥳</div>
