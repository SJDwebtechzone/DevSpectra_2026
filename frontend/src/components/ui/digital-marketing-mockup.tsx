      ...
      <div className="relative w-full max-w-[600px] aspect-[16/10] perspective-[1500px]">
          ...
          <div className="w-full h-full bg-[#111] rounded-t-3xl rounded-b-sm p-3 md:p-4 shadow-2xl relative z-10 border-t border-x border-gray-700/50">
            ...
            <div className="w-full h-full bg-white rounded-lg overflow-hidden flex text-gray-800 relative shadow-inner">
              ...
              <div className="w-16 md:w-20 bg-[#0f172a] flex flex-col items-center py-6 gap-6 shrink-0 z-10 border-r border-gray-800">
                <div className="w-8 h-8 bg-indigo-500 rounded-lg flex items-center justify-center text-white font-bold mb-4">
                  A
                </div>
                ...
                <div className="grid grid-cols-4 gap-3 mb-6">
                  {[
                    ...
                    >
                      ...
                      <div
                        className={`text-[9px] font-bold ${stat.up ? "text-emerald-500" : "text-emerald-500"}`}
                      >
                        {stat.up ? "↑" : "↓"} {stat.diff}
                      </div>
                    </div>
                ...
                <div className="flex gap-4 flex-1">
                  ...
                  <div className="flex-[2] bg-white border border-gray-100 rounded-xl p-4 shadow-sm flex flex-col">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div className="flex items-center gap-3 text-[9px] text-gray-500">
                        <div className="flex items-center gap-1">
                          <span className="w-2 h-2 rounded-full bg-indigo-600"></span> Clicks
                        </div>
                        <div className="flex items-center gap-1">
                          <span className="w-2 h-2 rounded-full bg-purple-300"></span> Conversions
                        </div>
                      </div>
                    </div>
                    <div className="flex-1 relative w-full mt-2">
                      ...
                      >
                        <path
                          d="M0,80 C30,70 60,100 100,70 C140,40 180,90 220,60 C260,30 300,50 350,20 C380,10 400,20 400,20"
                          fill="none"
                          stroke="#4f46e5"
                          strokeWidth="3"
                          strokeLinecap="round"
                        />
                        <path
                          d="M0,100 C40,110 80,70 120,90 C160,110 200,60 250,80 C300,100 350,50 400,60"
                          fill="none"
                          stroke="#d8b4fe"
                          strokeWidth="3"
                          strokeLinecap="round"
        ...
        >
          ...
          <svg viewBox="0 0 100 20" className="w-full h-6 overflow-visible">
            <path
              d="M0,15 L20,5 L40,10 L60,0 L80,15 L100,5"
              fill="none"
              stroke="#8b5cf6"
              strokeWidth="2"
            />
        ...
        >
          ...
          <div className="flex items-end gap-1 h-12">
            {[30, 50, 40, 60, 75, 100].map((h, i) => (
              ...
              >
                <div
                  className="w-full h-full bg-indigo-500 rounded-t-sm"
        ...
        >
          ...
          <svg viewBox="0 0 100 20" className="w-full h-6 overflow-visible">
            <path
              d="M0,20 C10,10 20,25 30,15 C40,5 50,20 60,10 C70,0 80,15 90,5 L100,10"
              fill="none"
              stroke="#3b82f6"
              strokeWidth="2.5"
              strokeLinecap="round"
