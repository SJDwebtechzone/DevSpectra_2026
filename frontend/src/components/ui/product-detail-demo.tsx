...
export default function ProductPageDemo() {
  const relatedProducts = [
    {
      id: 1,
      src: "https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8amFja2V0fGVufDB8fDB8fHww?q=80&w=800&auto=format&fit=crop",
      alt: "Similar Jacket",
    },
    {
      id: 2,
      src: "https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8c2hvc2V8ZW58MHx8MHx8fDA%3D?q=80&w=800&auto=format&fit=crop",
      alt: "Running Shoes",
    },
    {
      id: 3,
