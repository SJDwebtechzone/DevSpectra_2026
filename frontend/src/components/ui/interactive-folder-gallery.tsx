        ...
        <div className="relative w-[400px] h-[500px] flex justify-center pointer-events-none z-0">
                ...
                <motion.div
                  ...
                  onClick={() => {
                    if (isFolderOpen) {
                      ...
                      if (select && photo.title) {
                        select.value = photo.title;
                      }
                    }
                  }}
          ...
          >
            <div className="w-full h-full bg-gradient-to-b from-[#2a2a2a] to-[#111] rounded-2xl border border-white/20 shadow-[inset_0_2px_10px_rgba(255,255,255,0.1)] relative overflow-hidden flex items-end justify-center pb-8">
              ...
              <div className="px-6 py-3 bg-black rounded-xl border border-black/80 shadow-inner flex items-center justify-center backdrop-blur-md">
                <span className="text-white/90 text-2xl font-black tracking-widest uppercase">
                  {folderName}
                </span>
              </div>
            </div>
