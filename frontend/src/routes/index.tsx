              ...
              <div className="w-full lg:-ml-8 lg:w-[240px] shrink-0 flex flex-col justify-start py-0">
                <div className="mb-6">
                  ...
                  <div className="mt-1 flex items-center gap-2">
                    ...
                    <span className="text-xl tracking-[0.08em] text-[#fbbc05] sm:text-2xl">★★★★★</span>
                  </div>
                </div>
                ...
                <div className="mt-auto inline-flex rounded-full bg-[conic-gradient(from_210deg,#111827_0deg,#111827_48deg,#2563eb_62deg,#ef4444_78deg,#facc15_92deg,#f8fafc_112deg,#f8fafc_240deg,#111827_280deg,#111827_360deg)] p-[2px] shadow-[0_8px_18px_rgba(25,35,55,0.14)]">
                  ...
                  >
                    Write a review
                    <span className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-50 text-gray-900 shadow-sm">↗</span>
                  </a>
                </div>
              </div>
              ...
              >
                <div className="flex gap-6 w-max pl-6 lg:pl-0">
                  ...
                  {[...reviews, ...reviews, ...reviews, ...reviews].map((review: any, i: number) => (
                    ...
                    >
                      <div
                        className="h-full w-[300px] sm:w-[350px] rounded-[2rem] bg-white p-8 shadow-[0_4px_20px_rgb(0,0,0,0.03)] flex flex-col"
                      >
